...
The synthetic Carrier v1 path below remains unchanged. Real FMCSA Company Census now has its own [source-specific normalization and v2 candidate build](REAL_SOURCE_CONTINUITY.md), without coercion into this fixture schema.
